...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/admin/users-admin">Usuários</a></li>
    <li class="active"><a href="/admin/users-admin/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form id="usersCreate" action="/admin/users-admin/create" role="form" method="post">
          <?php if( $errorMsg != '' ){ ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?php if( isset($userDespersonForm) ){ ?> value="<?php echo htmlspecialchars( $userDespersonForm, ENT_COMPAT, 'UTF-8', FALSE ); ?>"  <?php } ?> >
            </div>
            <div class="form-group">
              <label for="nrphone">Telefone</label>
              <input type="tel" class="form-control" id="nrphone" name="nrphone" placeholder="Digite o telefone"
              <?php if( isset($userNrphoneForm) ){ ?> value="<?php echo htmlspecialchars( $userNrphoneForm, ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php } ?>>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <?php if( isset($userDesemailForm) ){ ?> value="<?php echo htmlspecialchars( $userDesemailForm, ENT_COMPAT, 'UTF-8', FALSE ); ?>"<?php } ?>  >
            </div>
